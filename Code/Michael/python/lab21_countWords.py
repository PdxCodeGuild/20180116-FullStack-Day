...
# for-loop interates through the index words. if words occurrence happens more than once, the value is incremented, if else occurrence only happens once, words in wordDictionary is assigned 1.
