...
# Check if it is a teen or single.
if input_number < 20 and input_number > 10:
    print(teens_list[input_number])
elif input_number < 10:
    print(singles_list[input_number])
elif input_number == 10:
    print(tens_list[1])
#elif input_number >= 100 and input_number:
#    hundreds = hundreds_list[hundreds_digit]
#    new_tens = hundred_remainders // 10
#    new_ones = hundred_remainders % 1
#    print(f'{} and {tens_list[new_tens] + dash + singles_list[new_ones]})
